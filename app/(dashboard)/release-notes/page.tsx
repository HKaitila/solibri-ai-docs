              ...
              {inputTab === 'analyze' && (
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full h-64 p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none font-mono text-sm text-gray-900 placeholder-gray-500"
                  />
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) => setReleaseNotes(e.target.value)}
                        placeholder="Paste your release notes here..."
                        className="w-full h-56 p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent resize-none font-mono text-sm text-gray-900 placeholder-gray-500"
                      />
                    </div>
                  </div>
                      ...
                      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 max-h-96 overflow-y-auto prose prose-sm max-w-none">
                        <ReactMarkdown
                          components={{
                            ...
                            code: ({ ...props }) => <code className="bg-gray-200 px-1 rounded text-sm font-mono text-gray-900" {...props} />,
                          }}
                        >
                          {compareResult.suggestedUpdate}
                        </ReactMarkdown>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 max-h-96 overflow-y-auto prose prose-sm max-w-none">
                  <ReactMarkdown
                    components={{
                      ...
                      h3: ({ ...props }) => <h3 className="text-lg font-bold mt-2 mb-1 text-gray-900" {...props} />,
                      p: ({ ...props }) => <p className="mb-2 text-gray-700" {...props} />,
                      ul: ({ ...props }) => <ul className="list-disc list-inside mb-2 text-gray-700" {...props} />,
                      ol: ({ ...props }) => <ol className="list-decimal list-inside mb-2 text-gray-700" {...props} />,
                      li: ({ ...props }) => <li className="mb-1 text-gray-700" {...props} />,
                      ...
                      em: ({ ...props }) => <em className="italic text-gray-800" {...props} />,
                      code: ({ ...props }) => <code className="bg-gray-200 px-1 rounded text-sm font-mono text-gray-900" {...props} />,
                      blockquote: ({ ...props }) => <blockquote className="border-l-4 border-gray-300 pl-4 italic my-2 text-gray-700" {...props} />,
                    }}
                  >
                    {createResult}
                  </ReactMarkdown>
